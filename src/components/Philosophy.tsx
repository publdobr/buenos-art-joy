const Philosophy = () => {
  return <section className="py-20 px-4 bg-gradient-to-br from-playful-pink/20 via-playful-yellow/20 to-playful-blue/20 relative overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-black mb-12 text-center font-archivo" style={{
